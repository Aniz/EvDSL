...
public class ReviewerUpdateScreenP extends JInternalFrame {
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				//EvCoMainScreenP.facade.updateUser(reviewer);
				EvCoMainScreenP.facade.updateReviewer(reviewer);
				//reviewer = EvCoMainScreenP.facade.searchReviewer(reviewer.getIdUser());
				textArea.setText("");
