...
import evco.ev.table.ActivitySpeakerTableModel;
import evco.ev.table.SpeakerTableModel;
...
public class ActivitySpeakerManagementScreenP extends JInternalFrame {
	...
	private class InsertButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				speaker =  new SpeakerTableModel(EvCoMainScreenP.facade.getSpeakerList()).get(rowIndex);
				int idActivity = EvCoMainScreenP.facade.getActivityIdByName(comboBox_Activities.getSelectedItem().toString());
				...
				//Inserindo na tabela
				EvCoMainScreenP.facade.insertActivitySpeaker(activitySpeaker);
				// buscando atividade com base no nome
				int i;
				i = EvCoMainScreenP.facade.getActivityIdByName(comboBox_Activities.getSelectedItem().toString());
				//Atualizando a tabela
				ActivitySpeakerTableModel model;
				model = new ActivitySpeakerTableModel(EvCoMainScreenP.facade.getActivitiesSpeakerById(i));
	...
	private class RemoveButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				activitySpeaker = new ActivitySpeakerTableModel(EvCoMainScreenP.facade.getActivitySpeakerList()).get(rowIndex);
				EvCoMainScreenP.facade.removeActivitySpeaker(activitySpeaker);
				//Atualizando a tabela
				int i;
				i = EvCoMainScreenP.facade.getActivityIdByName(comboBox_Activities.getSelectedItem().toString());
				ActivitySpeakerTableModel model;
	...
	private void populateTableSpeakers(){
		try {
			...
			model = new SpeakerTableModel(EvCoMainScreenP.facade.getSpeakerList());
