...
setTitle("Update Registration");
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				registration = EvCoMainScreenP.facade.searchRegistration(idRegistration);
			...
			try {
				EvCoMainScreenP.facade.updateRegistration(registration);
				registration = EvCoMainScreenP.facade.searchRegistration(registration.getIdRegistration());
				textArea.setText("");
