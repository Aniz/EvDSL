...
public class SpeakerUpdateScreenP extends JInternalFrame {
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				//EvCoMainScreenP.facade.updateUser(speaker);
				EvCoMainScreenP.facade.updateSpeaker(speaker);
				textArea.setText("");
				//textArea.append(EvCoMainScreenP.facade.searchUser(idUser).toString() +   speaker.toString());
