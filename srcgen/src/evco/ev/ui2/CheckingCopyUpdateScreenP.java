...
public class CheckingCopyUpdateScreenP extends JInternalFrame {
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				checkingCopy = EvCoMainScreenP.facade.searchCheckingCopy(idCheckingCopy);
			...
			try {
				EvCoMainScreenP.facade.updateCheckingCopy(checkingCopy);
				checkingCopy = EvCoMainScreenP.facade.searchCheckingCopy(checkingCopy.getIdCheckingCopy());
				textArea.setText("");
