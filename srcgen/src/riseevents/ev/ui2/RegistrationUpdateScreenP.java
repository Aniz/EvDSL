...
setTitle("Update Registration");
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				registration = RiseEventsMainScreenP.facade.searchRegistration(idRegistration);
			...
			try {
				RiseEventsMainScreenP.facade.updateRegistration(registration);
				registration = RiseEventsMainScreenP.facade.searchRegistration(registration.getIdRegistration());
				textArea.setText("");
