...
public class PaymentTableModel extends AbstractTableModel{
	...
	// Nome das Colunas
		...
		private static final int COL_LINK =7;
		private static final int COL_AAAA =8;
		private static final int COL_BBBB =9;
		private static final int COL_TYPEPAYMENT = 10;
		...
		//Preenchimento de cada coluna
			...
			public void alterarPayment(int indiceLinha, Payment payment) {
				...
				rows.get(indiceLinha).setLink(payment.getLink());
