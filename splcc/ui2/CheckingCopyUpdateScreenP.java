...
public class CheckingCopyUpdateScreenP extends JInternalFrame {
	...
	private class UpdateButtonAction  implements ActionListener{ 
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				checkingCopy = {{systemName}}MainScreenP.facade.searchCheckingCopy(idCheckingCopy);
			...
			try {
				{{systemName}}MainScreenP.facade.updateCheckingCopy(checkingCopy);
				checkingCopy = {{systemName}}MainScreenP.facade.searchCheckingCopy(checkingCopy.getIdCheckingCopy());
				textArea.setText("");
